...
public class AppMsg {
    ...
    /**
     * Cancels all queued {@link AppMsg}s, slide_in all Activities. If there is a {@link AppMsg}
    ...
    /**
     * Cancels all queued {@link AppMsg}s, slide_in given {@link android.app.Activity}.
    ...
    /**
     * Update the text slide_in a AppMsg that was previously created using one of the makeText() methods.
     *
     ...
     * <p><b>Note</b>: This only affects the order slide_in which the messages get shown,
    ...
    public static class Style {
        ...
        /**
         * Return the duration slide_in milliseconds.
         */
        public int getDuration() {
            return duration;
        }
