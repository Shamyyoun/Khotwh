...
public class ResideMenu extends FrameLayout {
    ...
    private View frameLayoutLeftImage;
    private ImageView imageLeftMenu;
    private ImageView imageRightMenu;
    /**
    ...
    // parameters
    private int leftMenuLogo;
    private int rightMenuLogo;
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            frameLayoutLeftImage = scrollViewLeftMenu.findViewById(R.id.frame_layout_left_image);
            imageLeftMenu = (ImageView) scrollViewLeftMenu.findViewById(R.id.image_left_menu);
        }
        ...
        if (customRightMenuId >= 0) {
            ...
            imageRightMenu = (ImageView) scrollViewRightMenu.findViewById(R.id.image_right_menu);
        }
    ...
    // --- NEW ---
    public void setLeftMenuLogo(int imageResId) {
        if (imageResId != 0) {
            this.leftMenuLogo = imageResId;
            imageLeftMenu.setImageResource(imageResId);
            frameLayoutLeftImage.setVisibility(VISIBLE);
        }
    }

    public void setRightMenuLogo(int imageResId) {
        this.rightMenuLogo = imageResId;
        imageRightMenu.setImageResource(imageResId);
        imageRightMenu.setVisibility(VISIBLE);
    }
}
